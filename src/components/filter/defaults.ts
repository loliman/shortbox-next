...
export function parseFilterValues(queryFilter?: string): FilterValues {
  ...
  try {
    ...
    return {
      ...
      onlyIssuesWithMultipleCollectedVariants: Boolean(parsed.onlyIssuesWithMultipleCollectedVariants),
      onlyNeededIssues: Boolean(parsed.onlyNeededIssues),
      onlyIncompleteSeries: Boolean(parsed.onlyIncompleteSeries),
      onlyUnownedFirstPrints: Boolean(parsed.onlyUnownedFirstPrints),
      onlyUnownedPublisherFirstPrints: Boolean(parsed.onlyUnownedPublisherFirstPrints),
      onlyNewUsMaterial: Boolean(parsed.onlyNewUsMaterial),
      excludeOnlyNewUsMaterial: Boolean(parsed.excludeOnlyNewUsMaterial),
      onlySellingList: Boolean(parsed.onlySellingList),
      onlyFirstOfMonthRelease: Boolean(parsed.onlyFirstOfMonthRelease),
      onlyNeededDeComics2024: Boolean(parsed.onlyNeededDeComics2024),

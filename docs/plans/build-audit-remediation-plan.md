...
5. Run `npm run lint`, `npm run test:a11y:pa11y`, and `npm run test:seo:unlighthouse` to verify the result.
6. Document remaining findings that require larger or riskier changes.
